...
**34 atomic rules** organized by prefix:
...
| `agent-connect-*` | 3 | MCP, CLI, HTTP connectivity |
| `agent-discovery-*` | 1 | Schema discovery workflow |
| `agent-query-*` | 1 | Query safety limits |
| `agent-format-*` | 1 | Output format selection |
